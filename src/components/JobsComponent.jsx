...
const JobsComponent = ({ currentLocale, id }) => {
    ...
    <>
        ...
        <hr text={i18n.JOBS.SEPARATOR} className="overflow-visible p-0 border-t-2 w-[90%] border-double dark:border-white text-center after:content-[attr(text)] after:inline-block after:relative after:top-[-1em] after:text-sm after:px-1 after:bg-[#d1d5db] after:dark:bg-[#171717]"/>
