...
longDescription: Plt2Img es una herramienta web que convierte código de Matplotlib en imágenes. Es ideal para desarrolladores y científicos de datos que desean generar visualizaciones a partir de código en Python sin necesidad de ejecutar el código localmente.
techs: [Astro, Python]
links:
