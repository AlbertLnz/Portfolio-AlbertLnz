...
shortDescription: Joc en Cloudinary Halloween Hackathon
longDescription: Where's Midu? Es un joc en línia amb temàtica de Halloween inspirat en "On està Wally?" que desafia als jugadors a trobar al reconegut desenvolupador Midudev i altres persones en imatges esgarrifoses generades per IA. Aquest projecte va ser desenvolupat per el Spooky AI Hackathon de Cloudinary i Midudev. Utilitzant les tecnologies de transformació i millora d'imatges en el núvol de Cloudinary, el joc millora dinàmicament la qualitat de les imatges generades per IA, fent-les més detallades i atractives.
